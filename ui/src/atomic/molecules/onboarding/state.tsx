              ...
              <div className="h-[calc(100vh-400px)] overflow-y-auto bg-transparent border border-input/30 rounded-lg p-2 space-y-1">
                {filteredStates.map((state) => (
                  <button
                    ...
                    className={cn(
                      "w-full p-3 text-left border rounded-lg transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
