...
async function setupCompleteVisitScheduling() {
  try {
    console.log('🏗️  COMPLETE VISIT SCHEDULING SETUP')
    ...
    // STEP 6: Create some availability overrides (for testing)
    console.log('\n📋 STEP 6: Creating Availability Overrides')
    ...
    console.log(`✅ Created ${overrides.length} availability overrides`)
    
    // STEP 7: Create sample appointments/visits for testing visits component
    console.log('\n📋 STEP 7: Creating Sample Appointments for Visits Testing')
    ...
    // STEP 8: Add medication preferences for comprehensive testing
    console.log('\n📋 STEP 8: Creating Medication Preferences')
    ...
    console.log('\n🎉 COMPLETE VISIT SCHEDULING SETUP FINISHED!')
    console.log('=' .repeat(50))
    console.log('')
    ...
    console.log('  • Provider has 10 schedule blocks (Mon-Fri, AM/PM)')
    console.log('  • 2 blocked time slots tomorrow for testing overrides')
    console.log('  • 3 sample appointments (2 completed, 1 scheduled) for visits component')
    console.log('  • 2 medication preferences for comprehensive patient view')
    console.log('  • All database relationships properly established')
    console.log('')
    ...
    console.log('  5. Test "Medications" tab for full patient view')
    console.log('  6. Verify appointment booking works with available time slots')
