...
async function assignProviderToPatient() {
  try {
    ...
    // Find provider by profile_id (auth uid: 4219e9f2-8349-4c21-ba99-3300fd076787)
    const { data: providerData, error: providerError } = await supabase
      .from('providers')
      .select('*')
      .eq('profile_id', '4219e9f2-8349-4c21-ba99-3300fd076787')
      .single()
    ...
    // Find patient by profile_id (auth uid: 61bd36ae-a949-4ae3-bc8e-2d05dace9571)
    const { data: patientData, error: patientError } = await supabase
      .from('patients')
      .select('*')
      .eq('profile_id', '61bd36ae-a949-4ae3-bc8e-2d05dace9571')
      .single()
