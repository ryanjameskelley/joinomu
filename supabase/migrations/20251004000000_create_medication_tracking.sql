-- Create medication tracking entries table
CREATE TABLE medication_tracking_entries (
...
CREATE INDEX idx_medication_tracking_patient_id ON medication_tracking_entries(patient_id);
CREATE INDEX idx_medication_tracking_preference_id ON medication_tracking_entries(medication_preference_id);
CREATE INDEX idx_medication_tracking_taken_date ON medication_tracking_entries(taken_date);
...
-- Admins can view all tracking entries
