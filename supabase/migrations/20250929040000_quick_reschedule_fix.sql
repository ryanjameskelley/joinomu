-- Quick fix for reschedule function
-- First ensure assignment_id column exists
ALTER TABLE appointments ADD COLUMN IF NOT EXISTS assignment_id UUID;

-- Create reschedule_appointment function
