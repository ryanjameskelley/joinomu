-- Ensure reschedule_appointment function exists with correct signature
...
COMMENT ON FUNCTION reschedule_appointment IS 'Reschedule an appointment to a new date and time';